...
- **Alerts:** textSize prop options from `small` & `large` to `sm` & `lg`

### Changed

- **Alerts:** conditional text and icon sizes
- **Alerts:** update stories file for improved examples
...
- **BadgeGroup:** update stories file for improved examples
