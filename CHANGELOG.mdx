...
- Fixed alignment issue in campaign banner

## [0.29.2]

### Changed

- Revert dependency update to work with cutheme
...
- Funding Details no longer requires an image
...
- Custom footer for FutureFunder

### Changed

- FutureFunder example templates
- Funding Details component
...
- Allowed videos to play inline in Full Video Banner

## [0.26.7]

### Change

- Change card excerpt type to accommodate bold and italic
...
- `cu-figure` class from `CardFigure`

## [0.26.2]

### Change

- React version to `18.3.1`
...
- Testing deployment issues with NPM and token deprecation
...
- Encrypted media console error on soundcloud embed.
...
- Full Video Banner missing videoName prop
- Fix HubSpot example
...
- Icon component's icon path for local vrs prod

## [0.25.3]

### Added

- Reference for grad studies video for `FullVideoBanner`

### Changed

- `useVideoBanner` helper function to use new CDN path

## [0.25.2]

### Changed

- Video Banner allows for external sources

## [0.25.1]

### Added

- New programs showcase video for Full Video Banner

## [0.25.0]

### Added

- JSON file asset generation### Added
- Time to read meta to listing header

### Fixed

- Incorrect icon colour on listing icon thumbs

## [0.24.5]

### Added

- Custom footer for Athletics

### Changed

- Ravens logo in footer

## [0.24.4]

### Changed

- Move `metaData` prop from `TextMedia` to `TextImage`

## [0.24.3]

### Fixed

- Issue with Icon paths, removed iconPath prop

## [0.24.2]

### Added

- Athletics promo video for splash page
- Added the option to testimonials to have left or right option in the component.

### Fixed

- Icon paths, requires new iconPath prop

## [0.24.1]

### Added

- Card Content subcomponent to provide more flexibility
- Custom class to apply coloured dots to inline text

## [0.24.0]

### Added

- `metaData` prop on PageHeader and TextMedia, intended for publishing date, time to read, categories

### Fixed

- Generic Server level page
...
- Refactored Icon component to support dynamic SVG loading from CDN or local path
- Added `basePath` prop to Icon for flexible asset location
- Removed color replacement logic for SVGs; now requires SVGs to use `currentColor`
- Improved sizing logic for icons
- Updated all components to use the new Icon API:
  - Alert
  - Button
  - CardEventMeta
  - CardIconThumb
  ...
  - TableHeader
  - Toast
- Updated Storybook icon gallery to use Icon component for rendering
- Added comments and documentation to Icon component for maintainability

## [0.22.2]

### Added

- Google map api key to github pages deployment
- New video entry for `FullBannerVideo` subcomponent

## [0.22.1]

### Fixed

- `WideBanner` was missing prop to set image alt

## [0.22.0]

### Added

- contained prop to the `FullBanner` component
- `WideBanner` component

### Changed

- Text overlay container width to better wrap text in `FullBanner`

### Fixed

- Top style of the nav button dropdown

## [0.21.5]

### Added

- Dropdown to `Nav.Buttons` components

### Removed

- `contentType` prop from `Splash` component content

### Fixed

- Content alignment of `Splash` component

## [0.21.4]

### Added

- Overlay without fade to `Splash` component

## [0.21.3]

### Added

- Opacity to `Splash` component
...
- `Pagination` elements by adding button ( clicking ) element
...
- Badge component added to index for exporting
...
- Unnecessary wrapping div on video in card component
