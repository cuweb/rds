...
- Installed new DOMPurify package to sanitize HTML

### Changed

- Updated Modal component to only accept children as prop. The component no longer accepts title and description as props.
- Changed isCenter option to be alignment to accommodate for left, right or center
