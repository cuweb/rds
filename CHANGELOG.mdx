...
- Refactored Main to include section wrapper, prose and set max width for basic content markup
- Refactored Section to have max width independent from the Main component
- Refactored Column to have wrapping div to allow independent max width setting
- Refactor Wide Image to remove max width option and clean up code
