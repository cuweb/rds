import{j as e}from"./jsx-runtime-X2b_N9AH.js";import{L as t}from"./Listing-CbKebI-L.js";import{I as u,P as i}from"./PeopleData-BkpwpMuk.js";import{E as s}from"./EventData-BT2hBXGJ.js";import{N as r}from"./NewsData-DZeLrR9d.js";import"./index-uCp2LrAq.js";import"./_commonjsHelpers-BosuxZz1.js";import"./parse-BFmE_n72.js";import"./format-DUBvZ7C8.js";import"./getDate-BfMQ2h7Y.js";import"./MapPinIcon-CRQ4FDTI.js";const U={title:"Components/Listing",component:t,tags:["autodocs"],parameters:{controls:{sort:"requiredFirst"}}},n={render:a=>e.jsx(t,{...a,children:e.jsxs(t.Body,{children:[e.jsx(t.Header,{title:"How to Write for the Web"}),e.jsx(t.Excerpt,{text:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut pharetra laoreet lobortis. In hac habitasse platea dictumst. Nulla porta posuere est, aliquam mollis mi accumsan id. Morbi mauris ex, gravida eu sodales sed, tempor vel mauris."}),e.jsx(t.Footer,{children:e.jsx("a",{href:"https://carleton.ca/webservices",className:"cu-button cu-button--red cu-button--small",children:"More info"})})]})})},o={render:a=>e.jsxs(t,{...a,children:[e.jsx(t.Figure,{children:e.jsx("img",{src:r.image,alt:r.alt,width:"400",height:"300"})}),e.jsxs(t.Body,{children:[e.jsx(t.Header,{title:r.title,date:r.date}),e.jsx(t.Excerpt,{text:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut pharetra laoreet lobortis. In hac habitasse platea dictumst. Nulla porta posuere est, aliquam mollis mi accumsan id. Morbi mauris ex, gravida eu sodales sed, tempor vel mauris."}),e.jsx(t.Footer,{children:e.jsx("a",{href:"https://carleton.ca/webservices",className:"cu-button cu-button--red cu-button--small",children:"Read more"})})]})]})},c={render:a=>e.jsxs(t,{...a,children:[e.jsx(t.DateThumb,{startDate:s.startDate,endDate:s.endDate}),e.jsxs(t.Body,{children:[e.jsx(t.Header,{title:s.title}),e.jsx(t.EventMeta,{startDateTime:s.startDate,endDateTime:s.endDate,onCampus:s.on_campus,onCampusBuilding:s.on_campus_building,onCampusRoomNumber:s.on_campus_room_number,eventAddress:s.event_address}),e.jsx(t.Footer,{children:e.jsx("a",{href:"https://carleton.ca/webservices",className:"cu-button cu-button--red cu-button--small",children:"Event details"})})]})]})},l={render:a=>e.jsxs(t,{...a,children:[e.jsx(t.IconThumb,{icon:u.icon}),e.jsxs(t.Body,{children:[e.jsx(t.Header,{title:u.title}),e.jsx(t.Excerpt,{text:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut pharetra laoreet lobortis. In hac habitasse platea dictumst."}),e.jsx(t.Footer,{children:e.jsx("a",{href:"https://carleton.ca/webservices",className:"cu-button cu-button--red cu-button--small",children:"Get informed"})})]})]})},m={render:a=>e.jsxs(t,{...a,children:[e.jsx(t.Figure,{isSquare:!0,children:e.jsx("img",{src:i.image,alt:i.alt,width:"280",height:"280"})}),e.jsxs(t.Body,{children:[e.jsx(t.Header,{title:`${i.firstName} ${i.lastName}`}),e.jsx(t.PeopleMeta,{jobTitle:i.jobTitle,phone:i.phone,children:e.jsx("a",{href:`mailto:${i.email}`,children:i.email})}),e.jsx(t.Footer,{children:e.jsx("a",{href:"https://carleton.ca/webservices",className:"cu-button cu-button--red cu-button--small",children:"View profile"})})]})]})};var d,p,g;n.parameters={...n.parameters,docs:{...(d=n.parameters)==null?void 0:d.docs,source:{originalSource:`{
...
}`,...(B=(F=m.parameters)==null?void 0:F.docs)==null?void 0:B.source}}};const $=["Default","NewsListing","EventListItem","IconListing","PeopleListing"];export{n as Default,c as EventListItem,l as IconListing,o as NewsListing,m as PeopleListing,$ as __namedExportsOrder,U as default};
