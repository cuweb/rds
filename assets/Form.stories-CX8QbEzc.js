import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{r as f}from"./index-7sdMIo0z.js";import{F as i,u as S,I as B}from"./InputAddon-CB3FW92_.js";import{c,b as x,a as Ve,d as O,f as ke,g as H,h as A}from"./index.esm-CZOmXW8O.js";import{P as je}from"./PageHeader-dKVTA0_m.js";import{M as Me}from"./Modal-DwGWRPOq.js";import{B as g}from"./ButtonGroup-CVkrxlV-.js";import{B as d}from"./Button-Cv42MwLr.js";import{a as Ce}from"./Location-CiHSvvE7.js";import"./index-yBjzXJbu.js";import"./_commonjsHelpers-BosuxZz1.js";import"./optionClasses-DR4HS9ih.js";import"./index-BLtdzZE9.js";import"./index-IE9ObSwG.js";import"./portal-CIXFCS-n.js";import"./use-server-handoff-complete-B3clrVmQ.js";import"./LocationPicker-Cn9xDH40.js";import"./index-Chjiymov.js";import"./MagnifyingGlassIcon-5uP8-6kH.js";import"./parseISO-53XxuXUY.js";import"./format-CoDaAjhx.js";import"./isSameDay-D4TUG8v2.js";import"./propClasses-BYrQ2lXe.js";import"./Icon-Cq1ojZpE.js";import"./Figure-_FP9E-7f.js";function qe(){return Math.random().toString(36).substring(7)}const we=Array.from({length:100},()=>{const r=qe();return{value:r,label:r}}),Ge=we,st={title:"Components/Form",component:i,tags:["autodocs"],parameters:{controls:{sort:"requiredFirst"}}},b=r=>new Promise(s=>setTimeout(s,r)),D=()=>{const r={inputText:""},s=c().shape({inputText:x().required("The field is required")}),m=async(p,G)=>{G.setSubmitting(!0),alert(JSON.stringify(p,null,2)),await b(1e3),G.setSubmitting(!1)},o=()=>{t.resetForm()},t=S({initialValues:r,validationSchema:s,onSubmit:m}),[a,n]=f.useState(!1),F=f.useRef(null),h=async p=>{console.log(p.currentTarget.value),t.setFieldValue("inputText",p.currentTarget.value),n(!0),await b(1e3),n(!1)};return f.useEffect(()=>{var p;a||(p=F==null?void 0:F.current)==null||p.focus()},[a]),e.jsxs(i,{formikProps:t,children:[e.jsx(i.FieldGroup,{children:e.jsx(i.FieldControl,{control:"text",label:"Label",name:"inputText",required:!0,helper:"Helper Text",helperpostop:!0,disabled:t.isSubmitting||a,ref:F,onChange:h})}),e.jsxs(g,{children:[e.jsx(d,{title:"Submit",type:"submit"}),e.jsx(d,{title:"Reset",type:"reset",color:"grey",onClick:o})]})]})},y=()=>{const[r,s]=f.useState(!1),m={inputText:""},o=c().shape({inputText:x().required("The field is required")}),t=async(F,h)=>{h.setSubmitting(!0),s(!0),await b(1e3),h.setSubmitting(!1)},a=()=>{n.resetForm()},n=S({initialValues:m,validationSchema:o,onSubmit:t});return e.jsxs(e.Fragment,{children:[e.jsxs(i,{formikProps:n,children:[e.jsx(i.FieldGroup,{children:e.jsx(i.FieldControl,{control:"text",label:"Label",name:"inputText",required:!0,helper:"Helper Text",hasPrefix:e.jsx(B,{border:"right",isGrey:!0,children:"$"}),hasSuffix:e.jsx(B,{border:"left",isGrey:!0,children:"USD"}),helperpostop:!0,disabled:n.isSubmitting})}),e.jsxs(g,{children:[e.jsx(d,{title:"Submit",type:"submit"}),e.jsx(d,{title:"Reset",type:"reset",color:"grey",onClick:a})]})]}),e.jsx(Me,{isOpen:r,setIsOpen:s,ariaLabel:"Modal label",ariaDescription:"The modal description",children:e.jsx(je,{as:"h2",header:"Modal content",size:"sm",isCenter:!0})})]})},T=()=>{const r={textareainput:""},s=c().shape({textareainput:x().required("The field is required")}),o=S({initialValues:r,validationSchema:s,onSubmit:async(t,a)=>{a.setSubmitting(!0),alert(JSON.stringify(t,null,2)),await b(1e3),a.setSubmitting(!1)}});return e.jsxs(i,{formikProps:o,children:[e.jsx(i.FieldGroup,{children:e.jsx(i.FieldControl,{control:"textarea",label:"Label",name:"textareainput",required:!0,helper:"Helper Text",disabled:o.isSubmitting})}),e.jsx(g,{children:e.jsx(d,{title:"Submit",type:"submit"})})]})},k=()=>{const r={checkbox:["no"]},s=c().shape({checkbox:Ve().min(1,"Please select at least one checkbox").required("Required")}),o=S({initialValues:r,validationSchema:s,onSubmit:async(t,a)=>{a.setSubmitting(!0),alert(JSON.stringify(t,null,2)),await b(1e3),a.setSubmitting(!1)}});return e.jsxs(i,{formikProps:o,children:[e.jsx(i.FieldGroup,{children:e.jsx(i.FieldControl,{control:"checkbox",name:"checkbox",label:"I acknowledge the statements above.",options:[{label:"Yes",value:"yes"},{label:"No",value:"no"}],required:!0,isInline:!0,disabled:o.isSubmitting})}),e.jsx(g,{children:e.jsx(d,{title:"Submit",type:"submit"})})]})},I=()=>{const r=[{label:"Option 1",value:"option1"},{label:"Option 2",value:"option2"},{label:"Option 3",value:"option3"}],s={radio:"option2"},m=c().shape({radio:x().required("Field value is required.")}),t=S({initialValues:s,validationSchema:m,onSubmit:async(a,n)=>{n.setSubmitting(!0),alert(JSON.stringify(a,null,2)),await b(1e3),n.setSubmitting(!1)}});return e.jsxs(i,{formikProps:t,children:[e.jsx(i.FieldGroup,{children:e.jsx(i.FieldControl,{control:"radio",label:"Label",name:"radio",options:r,isInline:!0,required:!0,disabled:t.isSubmitting,helper:"Helper Text"})}),e.jsx(g,{children:e.jsx(d,{title:"Submit",type:"submit"})})]})},v=()=>{const r=[{value:"1",label:"Option 1"},{value:"2",label:"Option 2"}],s={select:"2"},m=c().shape({select:x()}),t=S({initialValues:s,validationSchema:m,onSubmit:async(a,n)=>{n.setSubmitting(!0),alert(JSON.stringify(a,null,2)),await b(1e3),n.setSubmitting(!1)}});return e.jsxs(i,{formikProps:t,children:[e.jsx(i.FieldGroup,{children:e.jsx(i.FieldControl,{control:"select",label:"Select",name:"select",options:r,required:!0,disabled:t.isSubmitting})}),e.jsx(g,{children:e.jsx(d,{title:"Submit",type:"submit"})})]})},P=()=>{const r={startDate:"Sat Nov 23 2024 00:00:00 GMT-0500 (Eastern Standard Time)",endDate:""},s=c().shape({startDate:ke(()=>O().required("Please select start date").when("endDate",(t,a)=>t[0]?a.required("Start date can't be after end date"):a)),endDate:O().required("Please select end date").when("startDate",(t,a)=>t[0]?a.required("End date can't be before start date"):a)}),o=S({initialValues:r,validationSchema:s,onSubmit:async(t,a)=>{a.setSubmitting(!0),alert(JSON.stringify(t,null,2)),await b(1e3),a.setSubmitting(!1)}});return e.jsxs(i,{formikProps:o,children:[e.jsxs(i.FieldGroup,{cols:2,children:[e.jsx(i.FieldControl,{required:!0,control:"datetime",label:"Start Date",name:"startDate",maxDate:o.values.endDate,disabled:o.isSubmitting,isClearable:!0}),e.jsx(i.FieldControl,{required:!0,control:"datetime",label:"End Date",name:"endDate",minDate:o.values.startDate,disabled:o.isSubmitting})]}),e.jsx(g,{children:e.jsx(d,{title:"Submit",type:"submit"})})]})},V=()=>{const r={startDate:"",endDate:""},s=c().shape({startDate:ke(()=>O().required("Please select start date").when("endDate",(l,u)=>l[0]?u.required("Start date can't be after end date"):u)),endDate:O().required("Please select end date").when("startDate",(l,u)=>l[0]?u.required("End date can't be before start date"):u)}),o=S({initialValues:r,validationSchema:s,onSubmit:async(l,u)=>{u.setSubmitting(!0),alert(JSON.stringify(l,null,2)),await b(1e3),u.setSubmitting(!1)}}),[t,a]=f.useState(new Date),[n,F]=f.useState(new Date),h=new Date;h.setHours(0,0,0,0);const p=new Date;p.setHours(23,59,59,999);const G=f.useMemo(()=>{const l=new Date;if(l.setHours(0,0,0,0),t){const u=new Date(t);if(u.setHours(0,0,0,0),u.getTime()===l.getTime())return new Date}return h},[t,h]),Ie=f.useMemo(()=>{if(t){const l=new Date(t);return l.setHours(23,59,59,999),l}return p},[t,p]),ve=f.useMemo(()=>{const l=new Date;if(l.setHours(0,0,0,0),t){const u=new Date(t);return u.setMinutes(u.getMinutes()+1),u}else if(n&&n.getTime()===l.getTime()){const u=new Date(n);return u.setMinutes(u.getMinutes()+1),u}return h},[t,n,h]),Pe=f.useMemo(()=>{if(n){const l=new Date(n);return l.setHours(23,59,59,999),l}return p},[n,p]);return e.jsxs(i,{formikProps:o,children:[e.jsxs(i.FieldGroup,{cols:2,children:[e.jsx(i.FieldControl,{required:!0,control:"datetime",label:"Start Date",name:"startDate",maxDate:o.values.endDate,disabled:o.isSubmitting,showTime:!0,dateFormat:"MMMM d, yyyy h:mm aa",timeFormat:"HH:mm",minTime:G,maxTime:Ie,onChange:l=>{a(l)}}),e.jsx(i.FieldControl,{required:!0,control:"datetime",label:"End Date",name:"endDate",minDate:o.values.startDate,disabled:o.isSubmitting,showTime:!0,dateFormat:"MMMM d, yyyy h:mm aa",timeFormat:"HH:mm",minTime:ve,maxTime:Pe,onChange:l=>{F(l)}})]}),e.jsx(g,{children:e.jsx(d,{title:"Submit",type:"submit"})})]})},j=()=>{const r={image:[],file:[]},s=c().shape({image:H().test("fileSize","The image is required",t=>t&&t.length>0).required("The field is required"),file:H().test("fileSize","The file is required",t=>t&&t.length>0).required("The field is required")}),o=S({initialValues:r,validationSchema:s,onSubmit:async(t,a)=>{a.setSubmitting(!0),console.log(t,"values"),alert("Please check console log"),await b(1e3),a.setSubmitting(!1)}});return e.jsxs(i,{formikProps:o,children:[e.jsxs(i.FieldGroup,{children:[e.jsx(i.FieldControl,{control:"fileUpload",label:"Images",name:"image",required:!0,helper:"Helper Text",accept:"image/*",multiple:"multiple",disabled:o.isSubmitting,helperpostop:!0}),e.jsx(i.FieldControl,{control:"fileUpload",label:"Media",name:"file",required:!0,helper:"Helper Text",accept:"application/pdf,application/vnd.ms-excel",multiple:"multiple",disabled:o.isSubmitting,helperpostop:!0})]}),e.jsx(g,{children:e.jsx(d,{title:"Submit",type:"submit"})})]})},M=()=>{const r={text:"zlnud"},s=c().shape({text:x()}),m=()=>{t.resetForm()},t=S({initialValues:r,validationSchema:s,onSubmit:async(a,n)=>{n.setSubmitting(!0),alert(JSON.stringify(a,null,2)),await b(1e3),n.setSubmitting(!1),t.resetForm()}});return e.jsxs(i,{formikProps:t,children:[e.jsx(i.FieldGroup,{children:e.jsx(i.FieldControl,{control:"autosuggest",label:"Text",name:"text",placeholder:"Placeholder",disabled:t.isSubmitting,options:Ge})}),e.jsxs(g,{children:[e.jsx(d,{title:"Submit",type:"submit"}),e.jsx(d,{title:"Reset",type:"reset",color:"grey",onClick:m})]})]})},C=()=>{const r={text:"option7"},s=c().shape({text:x(),textName:x()}),m=()=>{t.resetForm()},t=S({initialValues:r,validationSchema:s,onSubmit:async(a,n)=>{n.setSubmitting(!0),alert(JSON.stringify(a,null,2)),await b(1e3),n.setSubmitting(!1),t.resetForm()}});return e.jsxs(i,{formikProps:t,children:[e.jsx(i.FieldGroup,{children:e.jsx(i.FieldControl,{control:"autosuggest",isSearchable:!0,label:"Auto Select Dropdown with typeahead",name:"text",onChange:a=>{a?t.setFieldValue("textName",a):t.setFieldValue("textName","")},disabled:t.isSubmitting,options:[{label:"--select an option--",value:""},{label:"Option 1",value:"option1"},{label:"Option 2",value:"option2"},{label:"Option 3",value:"option3"},{label:"Option 4",value:"option4"},{label:"Option 5",value:"option5"},{label:"Option 6",value:"option6"},{label:"Option 7",value:"option7"},{label:"Option 8",value:"option8"},{label:"Option 9",value:"option9"},{label:"Option 10",value:"option10"}],onBlur:()=>{console.log("onBlur is getting run"),t.values.text==="option5"&&t.setFieldValue("text","")}})}),e.jsx(i.FieldGroup,{children:e.jsx(i.FieldControl,{control:"text",label:"Selected Value",name:"textName",disabled:t.isSubmitting,helper:"This will have value only if auto suggest file selected",helperpostop:!0})}),e.jsxs(g,{children:[e.jsx(d,{title:"Submit",type:"submit"}),e.jsx(d,{title:"Reset",type:"reset",color:"grey",onClick:m})]})]})},q=()=>{const r={location:{coordinates:{lat:45.3850225,lng:-75.6946679},address:"Carleton University Raven's Nest"}},s=c().shape({location:c().shape({address:x(),coordinates:c().shape({lat:A(),lng:A()})})}),o=S({initialValues:r,validationSchema:s,onSubmit:async(t,a)=>{a.setSubmitting(!0),alert(JSON.stringify(t,null,2)),await b(1e3),a.setSubmitting(!1)}});return e.jsx(Ce,{googleMapsApiKey:void 0,libraries:["places"],children:e.jsxs(i,{formikProps:o,children:[e.jsx(i.FieldGroup,{children:e.jsx(i.FieldControl,{control:"placesAutoComplete",label:"Location Picker",name:"location",placeholder:"Placeholder",disabled:o.isSubmitting,helper:"Helper Text",showmap:!1})}),e.jsx(g,{children:e.jsx(d,{title:"Submit",type:"submit"})})]})})},w=()=>{const r=S({initialValues:{},onSubmit:()=>{}});return e.jsx(e.Fragment,{children:e.jsx(i,{formikProps:r,children:e.jsx(i.Error,{children:" Custom form error "})})})};D.__docgenInfo={description:"",methods:[],displayName:"Input"};y.__docgenInfo={description:"",methods:[],displayName:"InputAddonStory"};T.__docgenInfo={description:"",methods:[],displayName:"TextArea"};k.__docgenInfo={description:"",methods:[],displayName:"CheckBox"};I.__docgenInfo={description:"",methods:[],displayName:"Radio"};v.__docgenInfo={description:"",methods:[],displayName:"Select"};P.__docgenInfo={description:"",methods:[],displayName:"SimpleDate"};V.__docgenInfo={description:"",methods:[],displayName:"DateTime"};j.__docgenInfo={description:"",methods:[],displayName:"Media"};M.__docgenInfo={description:"",methods:[],displayName:"AutoSuggest"};C.__docgenInfo={description:"",methods:[],displayName:"AutoSelectSubsequentFields"};q.__docgenInfo={description:"",methods:[],displayName:"PlacesAutoComplete"};w.__docgenInfo={description:"",methods:[],displayName:"CustomFormError"};var E,N,Y;D.parameters={...D.parameters,docs:{...(E=D.parameters)==null?void 0:E.docs,source:{originalSource:`() => {
  type IInput = {
    inputText: string;
  };
...
}`,...(be=(pe=M.parameters)==null?void 0:pe.docs)==null?void 0:be.source}}};var Se,ge,he;C.parameters={...C.parameters,docs:{...(Se=C.parameters)==null?void 0:Se.docs,source:{originalSource:`() => {
  type IAutoSuggest = {
    text: string;
  };
  const autoSuggestInitialValues = {
...
}`,...(he=(ge=C.parameters)==null?void 0:ge.docs)==null?void 0:he.source}}};var fe,xe,Fe;q.parameters={...q.parameters,docs:{...(fe=q.parameters)==null?void 0:fe.docs,source:{originalSource:`() => {
...
}`,...(Fe=(xe=q.parameters)==null?void 0:xe.docs)==null?void 0:Fe.source}}};var De,ye,Te;w.parameters={...w.parameters,docs:{...(De=w.parameters)==null?void 0:De.docs,source:{originalSource:`() => {
  const formikProps = useFormik({
    initialValues: {},
    onSubmit: () => {}
  });
...
}`,...(Te=(ye=w.parameters)==null?void 0:ye.docs)==null?void 0:Te.source}}};const nt=["Input","InputAddonStory","TextArea","CheckBox","Radio","Select","SimpleDate","DateTime","Media","AutoSuggest","AutoSelectSubsequentFields","PlacesAutoComplete","CustomFormError"];export{C as AutoSelectSubsequentFields,M as AutoSuggest,k as CheckBox,w as CustomFormError,V as DateTime,D as Input,y as InputAddonStory,j as Media,q as PlacesAutoComplete,I as Radio,v as Select,P as SimpleDate,T as TextArea,nt as __namedExportsOrder,st as default};
