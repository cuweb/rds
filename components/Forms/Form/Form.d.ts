...
export declare const Form: {
    ...
    PlacesAutoComplete: ({ condition, ...props }: import("../PlacesAutoComplete/PlacesAutoComplete").PlacesAutoCompleteProps & import("formik").FieldHookConfig<object>) => JSX.Element;
};
