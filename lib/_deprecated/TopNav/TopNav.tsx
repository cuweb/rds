  ...
  const brandLogo = brand ? (
    ...
    <div className="flex items-center flex-shrink-0">
      <img
        ...
        alt="Carleton Shield"
      />
      <h1 className="flex items-center flex-shrink-0 pl-3 pr-2 text-2xl font-semibold">{title}</h1>
    </div>
  )
        ...
        <>
          <div className="flex h-20 gap-6 mx-auto max-w-7xl">
            ...
            <div className="hidden lg:flex lg:items-center lg:gap-6">
              ...
              {userInfo && !userMenuItems && <Avatar user={userInfo} size="xs" isCircle />}
              {userInfo && userMenuItems && (
                <DropDown listItems={userMenuItems} menuAlign="right">
                  <Avatar user={userInfo} size="xs" isCircle />
                </DropDown>
              )}
            </div>
          </div>
