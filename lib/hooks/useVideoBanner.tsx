...
export const BannerVideo = ({ videoName = 'cu-flyby' }: FullBannerVideoProps) => {
  useEffect(() => {
    VideoControls()
  }, [videoName])
  ...
  return (
    <>
      ...
      {/* <button
        className="cu-video-controls p-1.5 md:p-3 rounded-lg absolute right-0 -translate-x-4 lg:-translate-x-10 bottom-4 lg:bottom-8 z-50 w-8 h-8 md:w-14 md:h-14 fill-white bg-black/70 hover:bg-cu-red-700 transition-all"
