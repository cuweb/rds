  ...
  return (
    <>
      <video
        ...
        tabIndex={-1}
      >
        <source src={`https://cdn.carleton.ca/cu-media/videos/${videoType}/${videoName}.webm`} type="video/webm" />
        <source src={`https://cdn.carleton.ca/cu-media/videos/${videoType}/${videoName}.mp4`} type="video/mp4" />
