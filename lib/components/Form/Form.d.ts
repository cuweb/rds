...
export declare const Form: (({ children, formikProps }: FormWrapperProps) => import("react/jsx-runtime").JSX.Element) & {
    ...
    FormField: ({ children, label, hiddenLabel, name, maxWidth, helper, helperpostop, required, displayError, isLoading, isError, }: import('./FormField/FormField').FormFieldProps) => import("react/jsx-runtime").JSX.Element;
    FieldControl: import('../../../node_modules/react').ForwardRefExoticComponent<(Omit<import('./FieldControl/FieldControl').FieldControlProps, "ref"> | Omit<import('./FieldControl/FieldControl').FieldControlSetProps, "ref">) & import('../../../node_modules/react').RefAttributes<HTMLInputElement>>;
