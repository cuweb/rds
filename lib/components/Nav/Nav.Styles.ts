...
export const navMenuItemStyles = {
  ...
  navArrow: `after:content-[''] hover:after:border-current after:ml-1 after:mt-px after:border-t after:border-t-current after:border-l after:border-l-current after:rotate-[135deg] after:transition after:ease-in after:duration-300`,
