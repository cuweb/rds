...
export const NavBottom = ({ children }: PropsWithChildren) => {
  ...
  return (
    <div className="cu-nav__bottom bg-cu-black-25 border-t border-t-cu-black-100 w-[calc(100%+40px)] sm:w-[calc(100%+64px)] -mx-[20px] sm:-mx-[32px] px-[20px] sm:px-[2rem] py-2.5">
