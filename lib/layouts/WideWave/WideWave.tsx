...
export const WideWave = ({ children, wave = 'red', hasRaven = false }: WideWaveProps) => {
  ...
  return (
    <section
      className={`relative cu-widewaves cu-prose cu-prose-white ${waveBgClass} ${waveBgColor} ${edgePadding} ${topPadding} pb-8 md:pb-20 bg-[length:100.5%] bg-no-repeat cu-browsers-edge not-contained`}
