...
export const Default: Story = {
  render: () => (
    <>
      ...
      <div className="ql-editor prose prose-lg prose-rds max-w-none md:prose-xl prose-img:w-full prose-img:rounded-lg">
        <h2>H2 Heading</h2>
        <p>
        ...
        <p>
          ...
          <a href="https://google.com">Mattis mauris semper</a> sed amet vitae sed turpis id.
        </p>
        <p>
          <img
        ...
        <h4>H4 Heading</h4>
        <p>
          Purus morbi dignissim senectus mattis <a href="https://google.com">adipiscing</a> . Amet, massa quam varius
          orci dapibus volutpat cras. In amet eu ridiculus leo sodales cursus tristique. Tincidunt sed tempus ut viverra
          ridiculus non molestie. Gravida quis fringilla amet eget dui tempor dignissim. Facilisis auctor venenatis
