export const styles = {
  base: 'cu-hero-pagebanner not-contained not-prose mx-auto mb-12 grid gap-6 md:gap-10 lg:items-center',
  border: 'border-b border-cu-black-50 pb-6 shadow-hero-text-image md:pb-10',
  gridWithImage: 'md:grid-cols-hero-text-image-40',
  gridNoImage: 'md:grid-cols-hero-text-image-20',
