import { socialStyles } from './TextImage.Styles'
...
export const TextImageSocial = ({ resume, linkedin, twitter, facebook }: TextImageSocialProps) => {
  return (
...
TextImageSocial.displayName = 'TextImage.Social'
