import { socialStyles } from './PageHeaders.Styles'
...
export const PageHeadersSocial = ({ resume, linkedin, twitter, facebook }: PageHeadersSocialProps) => {
  return (
...
PageHeadersSocial.displayName = 'PageHeaders.Social'
